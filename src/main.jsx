...
function Overview({ items, go }) {
  ...
  return <><PageTitle eyebrow="Prioritisation & delivery view · Q3 planning" lens="Portfolio prioritisation and delivery review" title="Make the next best bet." desc="A single view of customer signal, delivery reality and measurable outcomes." action={<button className="primary" onClick={() => go('Opportunity backlog')}><Plus size={14} /> Review opportunities</button>} />
